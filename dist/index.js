...
FlightController.MAX_HELIS_START = 3;
FlightController.INCREASE_START_INTERVAL = 12;
...
class TrooperController {
    constructor(canvas, flightController) {
        this.canvas = canvas;
        this.flightController = flightController;
        this.reset = () => {
            this.troopers = [];
...
class Overlay {
    constructor(canvas, trooperController, flightController, highscores, score) {
        this.canvas = canvas;
        this.trooperController = trooperController;
        this.flightController = flightController;
...
class Highscores {
    constructor(score) {
        ...
        this.getHighScores = () => __awaiter(this, void 0, void 0, function* () {
            const highscores = this.db.collection('highscores');
            return yield highscores.orderBy('score', 'desc').limit(10).get();
        });
